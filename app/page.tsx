					...
					<div className="space-y-8">
						...
						<div>
							...
							<p className="text-muted-foreground">
								Create, manage, and visualize your data with AI-powered
								dashboards.
							</p>
						</div>
						...
						<div className="grid gap-4 md:grid-cols-2 items-stretch">
							<Card className="h-full">
								<CardHeader>
									...
									<CardDescription>
										Compose multiple graphs into a dashboard
									</CardDescription>
								</CardHeader>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Your Graphable workspace is linked to a Usable workspace
								</CardDescription>
							</CardHeader>
							<CardContent>
