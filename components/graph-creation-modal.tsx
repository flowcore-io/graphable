...
export function GraphCreationModal({
  ...
  const onSubmit = async (data: CreateGraphFormData) => {
    ...
    try {
      ...
      // Add graph to dashboard if position provided
      if (initialPosition && dashboardId) {
        // Fetch current dashboard layout
        ...
        if (dashboardResponse.ok) {
          ...
          // Add new tile to existing tiles
          const updatedTiles = [
            ...currentLayout.tiles,
            {
              graphRef: graphId,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Create a new graph to add to your dashboard</DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4">
              ...
              <Field>
                <FieldLabel>
                  Data Source Reference <span className="text-destructive">*</span>
                </FieldLabel>
                <FieldContent>
                  <Input
                    {...register("dataSourceRef")}
                    placeholder="data-source-id"
                    aria-invalid={!!errors.dataSourceRef}
                  />
                  <FieldDescription>Reference to the data source (placeholder until FR4)</FieldDescription>
